...
bookingRouter.get("/booking/date/:date/:playground_id?",(request,response)=>{
// console.log(request.params)
    bookingSchema.find({date:request.params.date,playground_id:+request.params.playground_id})
